            ...
            <View style={styles.addTaskContainer}>
                <View style={styles.calendarContainer}>
                    <View style={styles.startContainer}>
                        ...
                        >
                            <Icon
                                style={{ marginRight: 20, color: "#006EE9" }}
                                name="calendar"
                                size={25}
                            ></Icon>
                        ...
                        {showStartDatePicker && (
                            <DateTimePicker
                                ...
                                selectedItemColor={"#006EE9"}
                                todayContainerStyle={{borderWidth: 0.5, }}
                                monthContainerStyle={{borderRadius: 15, }}
                                yearContainerStyle={{borderRadius: 15, borderWidth: 0.5}}
                                selectedTextStyle={{fontSize: 10, fontWeight: 'bold'}}
                                calendarTextStyle={{fontSize: 10, fontWeight: 'bold'}}
                                dayContainerStyle={{width: 26, minHeight: 26}}
                            />
                        )}
                    </View>
                    <View style={styles.endContainer}>
                        ...
                        <TouchableOpacity
                            style={[
                                styles.endButton,
                                selectedDate === "end" && {backgroundColor:"#006EE9"}
                            ]}
                            
                            onPress={() => setShowEndDatePicker(true) && handleDateClick("end")}
                        >
                            <Icon
                                style={{ marginRight: 20, color: "#006EE9" }}
                                name="calendar"
                                size={25}
                            ></Icon>
                            <Text style={selectedDate === "end" && { color: "white"}}>{endDate.format("YYYY-MM-DD")}</Text>
                        </TouchableOpacity>
                        {showEndDatePicker && (
                            <DateTimePicker
                                mode="single"
                ...
                <View style={styles.categoryContainer}>
                    ...
                    <View style={styles.buttonsContainer}>
                        ...
                        >
                            <Text style={selectedCategory === "daily" && { color: "white" }}>
                                Daily task
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        >
                            <Text style={selectedCategory === "priority" && { color: "white" }}
                            >
                                Priority task
                            </Text>
                        </TouchableOpacity>
